<script>
	...
	const intro = [
      ...
      I love creating software that's fast, accessible, secure—and actually helps people.`,
      ...
      curious people to build great things—and leaving things better than I found them.`,
